/**
 * Long-form weight-loss articles (Indian diet, GM diet, vegetarian).
 * Served at /{slug} via app/[slug]/page.tsx
 */

export const weightLossBlogPosts = [
  {
    slug: 'gm-diet-plan-chart-for-weight-loss',
...
### How many kilograms can you lose in 7 days on the GM diet?

Many anecdotal reports mention roughly 5 to 8 kg, mostly from water. Results vary widely and scientific support is limited.

### Can I repeat the GM diet?

Some people repeat it after a gap of several days, but frequent repetition increases the risk of nutrient imbalance.

### Is the GM diet safe for vegetarians?

Yes, if you replace meat on days 5 and 6 with paneer, tofu, or legumes and keep protein adequate.

### Can I exercise during the GM diet?

Light activity such as walking or yoga is usually fine. Avoid very intense workouts, especially early in the week, if energy is low.

### What if I feel too hungry or weak?

Listen to your body. Stop if symptoms are severe and seek medical advice. Small adjustments may be possible with professional guidance.
    `,
    author: 'Dt. Alekya',
    date: '2026-04-01',
  ...
  {
    slug: 'indian-food-diet-plan-for-weight-loss',
...
1. **Balanced meals** - Each meal combines carbohydrates, protein, and fiber in sensible proportions.
2. **Portion control** - Smaller, regular meals can keep metabolism steadier than huge occasional feasts.
3. **Hydration** - Enough water and light herbal drinks support digestion and energy.
4. **Meal timing** - Earlier dinners and regular meal times can help some people with fat metabolism and sleep.
5. **Whole foods** - Prioritize fresh, home-cooked food over heavily processed snacks.
...
Sustainable loss is often about 0.5–1 kg per week on average, but it varies by person, activity, and medical history—always follow professional advice for your case.
  ...
  {
    slug: 'indian-diet-to-lose-weight-vegetarian-style',
